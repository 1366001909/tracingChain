					...
					<div class="row">
						<div class="three wide column">
							<div class="ui segment container center aligned">
								<div class="ui vertical  icon pointing menu">
									...
									<a class="item purple active" href="/storehouse/transactionPage">
						...
						<div class="eleven wide column">
							...
							<div class="ui segment container">
								...
								<form class="ui form" action="/storehouse/createTransaction" method="post">
									<div class="field">
										<label>发送方地址</label>
										<input type="text" name="senderAddress" placeholder="senderAddress">
									</div>
									<div class="field">
										<label>接收方地址</label>
										<input type="text" name="recipientAddress" placeholder="recipientAddress">
									</div>
									<div class="field">
										<label>交易的商品id</label>
										<input type="text" name="id" placeholder="id">
									</div>
									<button class="ui button purple basic center floated" type="submit">确认交易</button>

            ...
            <div class="row">
                <div class="three wide column">
                    <div class="ui segment container center aligned">
                        <div class="ui vertical  icon pointing menu">
                            <a class="item purple active" href="/storehouseCreate">
                ...
                <div class="eleven wide column">
                    ...
                    <div class="ui segment container">
                        ...
                        <form class="ui form" action="/storehouse/create" method="post">
                            <div class="field">
                                <label>仓库所在地</label>
                                <input type="text" name="storehouseAddress" placeholder="storehouseAddress">
                            </div>
                            <div class="field">
                                <label>管理人姓名</label>
                            ...
                            <button class="ui button purple basic center floated" type="submit">确认创建</button>
                        ...
                        <#if (result.msg)??>
                            <#if result.ok?string("yes","no")=="yes">
                                ...
                                <table class="ui celled padded  fixed table">
                                    <thead>
                                    <tr>
                                        <th class="five wide center aligned">仓库交易地址</th>
                                        <th class="two wide center aligned">仓库所在地</th>
                                        <th class="two wide center aligned">仓库联系人</th>

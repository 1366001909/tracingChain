                ...
                <div class="eleven wide column">
                    <div class="ui segment">
                        <div class="ui labeled right icon seven stackable menu">
                            ...
                            <a class="item purple active" href="/minePage">
                    ...
                    <div class="ui segment container ">
                        ...
                        <div class="ui inverted  dimmer">
                            <div class="ui indeterminate text loader">挖矿中</div>
                        </div>


                        <form class="ui form" action="/mine" method="post">
                            <div class="field">
                                <label>钱包地址</label>
                                <input type="text" name="address" placeholder="address">
                            </div>

                            <button class="ui button purple basic" id="mineButton">开始挖矿</button>

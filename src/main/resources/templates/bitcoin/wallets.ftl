                ...
                <div class="eleven wide column">
                    ...
                    <div class="ui segment container">
                        <table class="ui celled padded table">
                            <thead>
                            <tr>
                                <th class="center aligned">钱包地址</th>
                            </tr>
                            </thead>
                            <tbody>
                            <#if wallets??>
                                        ...
                                        <td>
                                            <div class="center aligned">
                                                ...
                                                <#if wallet.privateKey??>
                                                    <i class="m-margin-tb-tiny ui mini tag olive label"
                                                       style="margin-left: 30px">本地钱包</i>
                                                <#else>
                                                    <i class="m-margin-tb-tiny ui mini tag grey label"
                                                       style="margin-left: 30px">其它节点钱包</i>
                                                </#if>
                                            </div>
                                        </td>
                                    </tr>

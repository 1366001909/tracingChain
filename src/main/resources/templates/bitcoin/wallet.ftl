						...
						<div class="eleven wide column">
							<div class="ui segment">
								<div class="ui labeled right icon seven stackable menu">
									...
									<a class="item purple active" href="/wallet/create">
							...
							<div class="ui segment container">
								...
								<div class="ui success message fourteen wide column">
									...
									<p>钱包地址为: ${wallet.address}</p>
								</div>

								<table class="ui celled padded  fixed table">
									<thead>
										<tr>
											<th class="two wide center aligned">钱包地址</th>
											<th class="seven wide center aligned">钱包公钥</th>
											<th class="four wide center aligned">钱包私钥</th>
										</tr>
									</thead>
									<tbody>
										<tr>
